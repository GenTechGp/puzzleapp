...
#    - Buttons (Select all, Select none, Reset preferred, Reset file order, Save as preferred, Update table)
...
#
# UI tweak implemented in this version:
# - Visible columns checkbox grid remains unchanged and sits on top.
# - selectizeInput now uses full width of the page in its own row under the checkbox grid and is allowed to wrap to multiple rows
#   (no horizontal scrolling). The selectize area will grow vertically as needed (within a reasonable max height).
# - Button row unchanged (single horizontal line).
#
# Run:
